...
-- Dumping structure for table bout.inbox
CREATE TABLE IF NOT EXISTS `inbox` (
  ...
  `message` varchar(90) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Message content',
  `date` datetime DEFAULT NULL COMMENT 'Message send date',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table bout.inbox: ~0 rows (approximately)
